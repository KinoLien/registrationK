<?php 
  ...
  if(isset($_POST["action"])&&($_POST["action"]=="update")){
    ...
    if (md5($_POST["pwd"]) != $row_RecMember["m_pwd"]){
      header("Location: member_center.php?errMsg=1");
    }else{
      if ($_POST["m_pwd"] == '' && $_POST["m_passwordrecheck"] == '') {
        ...
        header("Location: member_center.php?loginStats=1");
      }else{
    ...
    <div class="container theme-showcase" role="main">
      <div class="jumbotron">
        ...
        <ul class="nav nav-tabs">
          ...
          <li>
            <a href="member_assistant.php">Assistant</a>
          </li>
        </ul>
